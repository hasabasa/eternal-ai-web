  ...
  <div className="max-w-6xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8 xl:px-16 py-4 sm:py-6 md:py-8 animate-section-entrance">
    <div className="text-center mb-4 sm:mb-6 md:mb-8 lg:mb-12">
      <div className="flex items-center justify-center gap-3 sm:gap-4 md:gap-6 mb-4 sm:mb-6 md:mb-8 animate-title-wave stagger-1 will-animate">
        <Briefcase className="w-6 h-6 sm:w-8 sm:h-8 md:w-10 md:h-10 lg:w-12 lg:h-12 text-brand-orange animate-icon-bounce" />
      ...
      <div className="bg-green-50/70 rounded-xl sm:rounded-2xl md:rounded-3xl border border-green-200/50 p-2 sm:p-3 md:p-4 lg:p-6 backdrop-blur-sm animate-card-wave stagger-3 will-animate">
        ...
        <div className="space-y-2 sm:space-y-3 md:space-y-4">
          <div className="text-center">
            <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-green-600 animate-number-pop stagger-2 will-animate">+20ч</div>
            <div className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 animate-text-reveal stagger-3 will-animate">Времени/неделю</div>
          </div>
          <div className="text-center">
            <div className="text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold text-green-600 animate-number-pop stagger-4 will-animate">+40%</div>
            <div className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 animate-text-reveal stagger-5 will-animate">Продуктивность</div>
          </div>
        </div>
      </div>
    </div>
