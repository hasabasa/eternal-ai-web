  ...
  <div className="max-w-6xl mx-auto px-4 animate-fade-in">
    <div className="text-center mb-8 md:mb-12">
      <div className="flex items-center justify-center gap-3 mb-4">
        <Flower className="w-6 h-6 md:w-8 md:h-8 text-brand-orange" />
    ...
    <div className="bg-green-50/70 rounded-2xl border border-green-200/50 shadow-lg p-6 backdrop-blur-sm mb-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center p-4 bg-white/50 rounded-xl">
          <div className="text-2xl md:text-3xl font-bold text-green-600 mb-2">+90%</div>
          <div className="text-sm text-gray-600">Увеличение конверсии</div>
        </div>
        <div className="text-center p-4 bg-white/50 rounded-xl">
          <div className="text-2xl md:text-3xl font-bold text-green-600 mb-2">80%</div>
          <div className="text-sm text-gray-600">Автоматизация обращений</div>
        </div>
        <div className="text-center p-4 bg-white/50 rounded-xl">
