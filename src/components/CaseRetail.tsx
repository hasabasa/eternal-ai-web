  ...
  <div className="max-w-7xl mx-auto px-8 animate-fade-in">
    <div className="text-center mb-20">
      <div className="flex items-center justify-center gap-6 mb-8">
        <Flower className="w-16 h-16 text-brand-orange" />
      ...
      <div className="bg-green-50/70 rounded-3xl border border-green-200/50 p-16 backdrop-blur-sm">
        ...
        <div className="space-y-8">
          <div className="text-center">
            <div className="text-5xl lg:text-6xl font-bold text-green-600">+150%</div>
            <div className="text-2xl text-gray-600">Рост продаж</div>
          </div>
          <div className="text-center">
            <div className="text-5xl lg:text-6xl font-bold text-green-600">90%</div>
            <div className="text-2xl text-gray-600">Конверсия</div>
          </div>
        </div>
      </div>
    </div>
