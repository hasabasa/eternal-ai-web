    ...
    <div className="w-full max-w-6xl mx-auto">
      <div className="text-center mb-3 sm:mb-4 md:mb-6">
        <div className="flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-2 sm:mb-3 md:mb-4 animate-title-wave stagger-1 will-animate">
          <Coffee className="w-4 h-4 sm:w-6 sm:h-6 md:w-8 md:h-8 lg:w-10 lg:h-10 text-brand-orange animate-icon-bounce" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 sm:gap-3 md:gap-4 mb-3 sm:mb-4 md:mb-6">
        ...
        <div className="bg-green-50/70 rounded-lg sm:rounded-xl md:rounded-2xl border border-green-200/50 p-2 sm:p-3 md:p-4 backdrop-blur-sm animate-card-wave stagger-3 will-animate">
          <div className="flex items-center gap-1 sm:gap-2 md:gap-3 mb-2 sm:mb-3">
            <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 lg:w-6 lg:h-6 text-green-600 animate-icon-bounce" />
          ...
          <div className="space-y-1 sm:space-y-2">
            <div className="text-center">
              <div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold text-green-600 animate-number-pop stagger-2 will-animate">180К₽</div>
              <div className="text-xs sm:text-sm text-gray-600 animate-text-reveal stagger-3 will-animate">Экономия/мес</div>
            </div>
            <div className="text-center">
              <div className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl font-bold text-green-600 animate-number-pop stagger-4 will-animate">-95%</div>
              <div className="text-xs sm:text-sm text-gray-600 animate-text-reveal stagger-5 will-animate">Ошибок</div>
            </div>
          </div>
        </div>
      </div>
