  ...
  <div className="max-w-6xl mx-auto px-4 animate-fade-in">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      {solutions.map((solution, i) => (
        <div
          key={i}
          className="bg-white/90 rounded-3xl p-10 shadow-lg border border-gray-200 hover:shadow-xl transition-all group"
        >
          <div className="flex items-start gap-6 mb-6">
            ...
            <div className="flex-1">
              <h3 className="text-2xl font-bold mb-3 text-brand-darkBlue">
                {solution.title}
              </h3>
          ...
          <div className="flex flex-wrap gap-3">
            {solution.features.map((feature, j) => (
              <span
                key={j}
                className="px-4 py-2 bg-brand-purple/10 text-brand-purple rounded-full text-base font-medium"
              >
                {feature}
              </span>
            ))}
