...
const solutions = [
  {
    icon: <MessageCircle className="w-4 h-4 text-brand-purple" />,
    title: "Чат-боты",
  ...
  <div className="max-w-4xl mx-auto px-6 sm:px-8 animate-fade-in">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      {solutions.map((solution, i) => (
        <div
          key={i}
          className="bg-white/80 rounded-xl p-4 shadow-lg border border-white/40 hover:bg-white/95 transition-all backdrop-blur-sm"
        >
          <div className="flex items-start gap-3 mb-3">
            ...
            <div className="flex-1">
              <h3 className="text-base font-bold mb-1 text-brand-darkBlue">
                {solution.title}
              </h3>
