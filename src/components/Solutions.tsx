...
const Solutions = () => {
  return <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 animate-curtain-reveal">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {solutionsData.map((solution, index) => <div key={index} className={`bg-white/80 rounded-3xl border border-white/40 shadow-xl p-6 hover:bg-white/95 transition-all backdrop-blur-sm hover-lift will-animate animate-card-wave stagger-${index + 1} flex flex-col`}>
