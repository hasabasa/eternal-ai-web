...
const advantages = [
  ...
  {
    icon: <Users className="w-4 h-4 text-brand-purple" />,
  ...
  <div className="max-w-4xl mx-auto px-6 sm:px-8 animate-fade-in">
    ...
    <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
      {advantages.map((item, i) => (
        <div
          key={i}
          className="bg-white/80 rounded-xl p-3 shadow-lg border border-white/40 hover:bg-white/95 transition-all backdrop-blur-sm text-center"
        >
