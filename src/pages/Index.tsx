      ...
      >
        <CarouselContent className="-mt-0 h-full">
          ...
          <CarouselItem className="pt-0 basis-full">
            <section className="h-full flex items-center justify-center px-8 lg:px-16 bg-gradient-to-br from-white to-brand-orange/5">
          ...
          {/* Статистика */}
          <CarouselItem className="pt-0 basis-full">
            <section className="h-full flex items-center justify-center py-12 bg-gradient-to-br from-brand-purple/5 to-brand-orange/10">
              <Statistics />
            </section>
          </CarouselItem>
          ...
          {/* Решения */}
          <CarouselItem className="pt-0 basis-full">
            <section className="h-full flex items-center justify-center py-12 bg-gradient-to-br from-brand-orange/5 to-brand-darkBlue/10">
              <Solutions />
            </section>
          </CarouselItem>
          ...
          {/* Преимущества */}
          <CarouselItem className="pt-0 basis-full">
            <section className="h-full flex items-center justify-center py-12 bg-gradient-to-br from-brand-darkBlue/5 to-brand-purple/10">
              <Advantages />
            </section>
          </CarouselItem>
