    ...
    <div className="relative min-h-screen flex flex-col overflow-x-hidden snap-y snap-mandatory">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 snap-start animate-fade-in">
        <div className="max-w-4xl mx-auto text-center">
          {/* Логотип */}
          <div className="font-extrabold text-[48px] sm:text-[64px] text-primary tracking-tight mb-8 select-none drop-shadow leading-none">
            Вечный ИИ
          </div>
          
          {/* Тэглайн */}
          <div className="text-base sm:text-lg bg-gradient-to-r from-aurora5 to-aurora4 text-white px-6 py-3 rounded-full font-medium mb-8">
            🚀 Революция в автоматизации бизнеса
          </div>

          {/* Заголовок */}
          <h1 className="text-[2.5rem] sm:text-[3.5rem] font-bold text-black text-center leading-tight mb-6">
            Рост эффективности бизнеса —<br className="hidden sm:block"/> без затрат на сотрудников
          </h1>
          
          <h2 className="text-[2rem] sm:text-[2.8rem] font-bold text-aurora4 mb-8">
            ИИ, который работает за людей
          </h2>
          
          {/* Описание */}
          <p className="text-xl sm:text-2xl text-muted-foreground text-center max-w-4xl mx-auto leading-relaxed">
      ...
      <section className="min-h-screen flex items-center justify-center snap-start">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <div className="bg-gradient-to-br from-white/90 to-white/70 rounded-3xl p-12 md:p-16 shadow-xl border border-muted">
            ...
            <div className="text-lg text-muted-foreground opacity-80">
